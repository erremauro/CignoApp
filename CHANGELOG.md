...
## [1.2.1]
## :bug: Bug Fix
- Fix chord shape rendering in renderSong.ts

## [1.2.0]
## :pencil: Changed
- Add support for servings other than Peoples (e.g.: quantities)
- Servings label renamed to "Servings" instead of "People"
...
[Unreleased]: https://github.com/erremauro/CignoApp/compare/v1.2.1...HEAD
[1.2.1]: https://github.com/erremauro/CignoApp/releases/tag/v1.2.1
[1.2.0]: https://github.com/erremauro/CignoApp/releases/tag/v1.2.0
[1.1.1]: https://github.com/erremauro/CignoApp/releases/tag/v1.1.1
